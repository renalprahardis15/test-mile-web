...
WebUI.setText(findTestObject('Page_Mile.app  Login/Account_OR/input_Email Address or Username_email or username'), 'test@mailinator.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mile.app  Login/Account_OR/input_Password_password'), 'tzH6RvlfSTg=')
