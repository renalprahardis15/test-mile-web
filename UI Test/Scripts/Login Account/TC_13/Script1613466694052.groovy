...
WebUI.setText(findTestObject('Page_Mile.app  Login/Account_OR/input_Email Address or Username_email or username'), '')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mile.app  Login/Account_OR/input_Password_password'), 'P9ET2sDE0SE=')
...
WebUI.verifyTextPresent('The email or username field is required', false)

WebUI.verifyTextPresent('The password field must be at least 6 characters', false)
